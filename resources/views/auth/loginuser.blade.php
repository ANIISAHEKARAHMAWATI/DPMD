...
<head>
    <title>Admin DPMD Kabupaten Jombang</title>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" type="text/css"
        href="{{asset('login/Login_v16/fonts/font-awesome-4.7.0/css/font-awesome.min.css')}}">
    <link rel="stylesheet" type="text/css"
        href="{{asset('login/Login_v16/fonts/Linearicons-Free-v1.0.0/icon-font.min.css')}}">
    ...
    <link rel="stylesheet" type="text/css"
        href="{{asset('login/Login_v16/vendor/daterangepicker/daterangepicker.css')}}">
...
<body>
    ...
    <div class="limiter">
        <div class="container-login100" style="background-color:#2c6f4a;">
