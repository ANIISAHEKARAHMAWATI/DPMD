        ...
        <div class="col">
            <form action="searchartikel">
                <div class="input-group">
                    <input class="form-control" type="text" placeholder="Search" name="searchartikel"
                        value="{{ request('searchartikel') }}" aria-label="Search">
                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <p class="card-text" style="font-size: 13px;"><small
