...
@section('title', 'Visi Misi & Dokumen')
                ...
                <div class="mb-3 kartukiri">
                    <div class="row g-0 clearfix">
                        <div class=" col-md-4 mt-5">
                            <img src="{{ asset('prodamasProd/' . $prodamas->foto) }}" class="img-fluid rounded-start"
                                alt="Gambar Sejarah Prodamas">
                        </div>
                ...
                <div class="mb-3 kartukanan">
                    <div class="row g-0">
                        <div class="col-md-8">
                            <div class="card-body isi">
                                <h4 style="font-family: Inter, sans-serif; text-decoration-line: underline; text-decoration-style: double;"
                                    class="card-title">{{ $prodamas->judul }}</h4>
                                <p class="card-text">
                                    <?= $prodamas->caption ?>
                                </p>
                            </div>
