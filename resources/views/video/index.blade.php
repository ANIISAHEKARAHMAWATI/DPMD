...
<!-- Awal feed video -->
<div class="row row-cols-1 row-cols-md-3 mb-2 g-4 px-5 m-5 centerItms feedVideo">
    {{-- Card video 1 --}}
    ...
    <div class=" card noBorder cardAudio mx-1" style="width: 18rem; cursor: pointer;">
        <div class="card h-100 noBorder" data-bs-toggle="modal" data-bs-target="#audioPlayer{{ $video->id }}">
            <img src="{{ asset('/videoProd/sampul/' . $video->gambar_sampul) }}" style="object-fit: cover;"
    ...
    {{-- Card Modal --}}
    <div class="modal fade" id="audioPlayer{{ $video->id }}" tabindex="-1" aria-labelledby="audioPlayerLabel"
        aria-hidden="true">
                ...
                <div class="modal-body">
                    <div class="row row-cols-1 row-cols-md-3 mb-2 g-4 videoPlayerBox centerItms">
                        <div class="card" style="
                            ...
                            <iframe width="fixed" height="fixed" src="{{ $video->konten }}" title="YouTube video player"
                                frameborder="0"
